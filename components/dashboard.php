...
<body>
    ...
    $get_data_query = "SELECT 
            ...
            LEFT JOIN tbl_positions tp on tp.position_id = td.position
            LEFT JOIN tbl_department dp on dp.dept_id = td.department";
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <canvas id="performanceBarChart" height="400"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="employeeModal" tabindex="-1" aria-labelledby="employeeModalLabel" aria-hidden="true">
        ...
        <script>
            ...
            function initializePerformanceBarChart(filteredEmployees = null) {
                ...
                // Limit to top 15 employees for better readability
                const topEmployees = sortedEmployees.slice(0, 15);
                const labels = topEmployees.map(emp => emp.emp_name || `Employee #${emp.emp_id}`);
                const data = topEmployees.map(emp => emp.performance || 0);

                // Simplified solid colors
                    ...
                    options: {
                        ...
                        onClick: (event, elements) => {
                            if (elements.length > 0) {
                                ...
                                const empId = topEmployees[index].emp_id;
